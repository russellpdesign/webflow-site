...
let imgContainerXPosition = scaleDownImgContainerDebug.getBoundingClientRect().left;
let imgContainerYPosition = scaleDownImgContainerDebug.getBoundingClientRect().top;
// the image in our horizontal scroll section
const endingImageDebug = document.querySelector("#scale-down-img-after");
let endingImageXPosition = endingImageDebug.getBoundingClientRect().left;
let endingImageYPosition = endingImageDebug.getBoundingClientRect().top;
